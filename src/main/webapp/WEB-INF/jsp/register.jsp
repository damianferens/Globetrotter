...
<body>
	...
	<div class="container">
		<h2 class="display-1">Rejestracja</h2>

		<form class="form" action="register" method="post">
			<div class="form-group">
				<input type="text" class="form-control"
					placeholder="Imię i nazwisko" name="name">
			</div>
			<div class="form-group">
			...
			<button type="submit" class="btn btn-default button">Zarejestruj</button>
			<p class="pError">${registerError}</p>
		</form>
	</div>
